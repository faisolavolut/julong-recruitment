    ...
    <div className="flex p-4 flex-col flex-grow bg-white rounded-lg border border-gray-300 shadow-md shadow-gray-300">
      <div className="flex flex-col py-4 pb-0 pt-0">
        <h2 className="text-xl font-semibold text-gray-900 ">
          <span className="">FGD Result</span>
        </h2>
      </div>
      <div className="w-full flex flex-row flex-grow bg-white overflow-hidden ">
        <TableList
            ...
            sideLeft: (data: any) => {
              ...
              return (
                <div className="flex flex-row flex-grow">
                  <ButtonLink className="bg-primary" href={"/d/fgd/result/new"}>
          ...
          column={[
            ...
            {
              name: "status_result",
              header: () => <span>Status Result</span>,
              renderCell: ({ row, name }: any) => {
                return <>{getValue(row, name)}</>;
              },
            },
              ...
              renderCell: ({ row }: any) => {
                return (
                  <div className="flex items-center gap-x-0.5 whitespace-nowrap">
                    {local.can_edit ? (
                      <ButtonLink href={`/d/fgd/result/${row.id}/edit`}>
