    ...
    <FormBetter
      ...
      onSubmit={async (fm: any) => {
        ...
        const res = await apix({
          port: "recruitment",
          value: "data.data",
          path: "/api/question-responses/answer-fgd",
          method: "post",
          data: {
      ...
      onLoad={async () => {
        ...
        let fgd_applicant: any = null;
        try {
          fgd_applicant = await apix({
            port: "recruitment",
            value: "data.data",
        ...
        const list_assessor = data?.fgd_assessors || [];
        ...
        return {
          ...data,
          status: fgd_applicant?.status || "DRAFT",
