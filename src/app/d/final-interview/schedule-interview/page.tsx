...
function Page() {
  ...
  useEffect(() => {
    const run = async () => {
      ...
      local.can_add = getAccess("create-final-schedule-interview", roles);
      local.can_edit = getAccess("edit-final-schedule-interview", roles);
      local.render();
    };
    run();
  }, []);
              ...
              return (
                <div className="flex flex-row flex-grow">
                  <ButtonLink
                    ...
                    href={"/d/final-interview/schedule-interview/new"}
                  >
              ...
              renderCell: ({ row }: any) => {
                return (
                  <div className="flex items-center gap-x-0.5 whitespace-nowrap">
                    {local.can_edit ? (
                      <ButtonLink
                        href={`/d/final-interview/schedule-interview/${row.id}/edit`}
                      >
                      ...
                      <ButtonLink
                        className="bg-primary"
                        href={`/d/final-interview/schedule-interview/${row.id}/view`}
                      >
                        <div className="flex items-center gap-x-2">
