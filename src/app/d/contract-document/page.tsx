...
function Page() {
  ...
  useEffect(() => {
    const run = async () => {
      ...
      local.can_add = getAccess("create-contract-document", roles);
      local.can_edit = getAccess("edit-contract-document", roles);
      local.render();
    };
    run();
  }, []);
              ...
              renderCell: ({ row }: any) => {
                return (
                  <div className="flex items-center gap-x-0.5 whitespace-nowrap">
                    {local.can_edit ? (
                      <ButtonLink href={`/d/contract-document/${row.id}/edit`}>
                      ...
                      <ButtonLink
                        className="bg-primary"
                        href={`/d/contract-document/${row.id}/view`}
                      >
                        <div className="flex items-center gap-x-2">
